...
type Resolvers interface {
	Message_user(ctx context.Context, obj *Message) (*User, error)

	Mutation_postMessage(ctx context.Context, text string) (*Message, error)
	Query_messages(ctx context.Context, skip *int, take *int) ([]Message, error)
...
func (ec *executionContext) _Message_user(ctx context.Context, field graphql.CollectedField, obj *Message) graphql.Marshaler {
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Message_user(ctx, obj)
		})
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
...
func (ec *executionContext) _Query_messages(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Query_messages(ctx, args["skip"].(*int), args["take"].(*int))
		})
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
